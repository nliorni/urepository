...
reorder_keep = ["chr", "pos", "ref", "alt", "qual", "filter", "TotalDepth", "AlleleDepth", "GenotypesLikelihood", "GeneSymbol", "GeneFunction", "Consequence", "RefSeqTranscriptId", "Strand", "cDNAposition", "CDSposition", "ProteinPosition", "Codons", "Exon", "Intron", "GeneDetail", "HGVSp", "AminoAcids", "InterproDomain", "dbSNP", "ClinVarCLNSIG", "ClinVarCLNDN", "GERP++_RS", "phyloP100way_vertebrate", "CADD_PHRED", "SIFT", "DANN_score", "DEOGEN2_pred", "Eigen-phred_coding", "FATHMM_pred", "LRT_pred", "M-CAP_pred", "MetaLR_pred", "MetaSVM_pred",  "MutationAssessor_pred", "MutationTaster_pred", "PROVEAN_pred", "Polyphen2_HDIV_pred", "Polyphen2_HVAR_pred", "REVEL_score", "MutPred_Top5features", "fathmm-MKL_coding_pred", "fathmm-XF_coding_pred", "gnomAD_211_AF", "gnomAD_211_AF_afr", "ExAC_AF", "ExAC_AFR_AF", "ESP6500_AA_AF", "ESP6500_EA_AF", "PredictorsCount"]
...
tonum = ["TotalDepth", "GERP++_RS", "phyloP100way_vertebrate", "DANN_score", "Eigen-phred_coding", "REVEL_score", "gnomAD_211_AF", "gnomAD_211_AF_afr", "ExAC_AF", "ExAC_AFR_AF", "ESP6500_AA_AF", "ESP6500_EA_AF"]
